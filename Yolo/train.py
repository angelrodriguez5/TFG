...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment_name", type=str, default="ttvxt_10000", help="name of the folder to save logs, checkpoints...")
    ...
    parser.add_argument("--test_interval", type=int, default=100, help="interval evaluations on test set")
